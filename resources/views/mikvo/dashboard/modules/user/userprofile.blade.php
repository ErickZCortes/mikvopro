            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-4">
                            ...
                            <img class="img-fluid rounded mx-auto d-block" src="{{URL::asset('uploads/user.png') }}" alt="" width="250" height="250"> 
                                
                            @else
                                <img class="img-fluid rounded mx-auto d-block" src="{{ asset('uploads/'.$user->img_user) }}" alt="" width="250" height="250">
                            @endif 
                            <hr>
